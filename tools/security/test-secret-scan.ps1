...
try {
    ...
    & powershell -NoProfile -ExecutionPolicy Bypass -File $scanner -RepoRoot $RepoRoot -Path $safeFile
    ...
    $output = & powershell -NoProfile -ExecutionPolicy Bypass -File $scanner -RepoRoot $RepoRoot -Path $secretFile 2>&1
